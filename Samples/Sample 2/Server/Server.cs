...
namespace Server_NS
{
    ...
    public partial class Server : Form
    {
        ...
        public List<Connections> __ClientSockets { get; set; }
        ...
        public Server()
        {
            ...
            InitializeComponent();
            __ClientSockets = new List<Connections>();
        }
        ...
        private void SetupServer()
        {
            ...
            _serverSocket.Bind(new IPEndPoint(IPAddress.Any, 1025));
        ...
        private void AppceptCallback(IAsyncResult ar)
        {
            ...
            __ClientSockets.Add(new Connections(socket));
